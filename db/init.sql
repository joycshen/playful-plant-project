...
CREATE TABLE entries (
    ...
    exploratory_constructive_play_present INTEGER NOT NULL,
    exploratory_sensory_play_present INTEGER NOT NULL,
    physical_play_present INTEGER NOT NULL,
    imaginative_play_present INTEGER NOT NULL,
    restorative_play_present INTEGER NOT NULL,
    play_with_rules_present INTEGER NOT NULL,
    bio_play_present INTEGER NOT NULL,
...
INSERT INTO
    entries(id, name_colloquial, name_genus_species, plant_id, exploratory_constructive_play_present, exploratory_sensory_play_present, physical_play_present, imaginative_play_present, restorative_play_present, play_with_rules_present, bio_play_present, perennial, full_sun, partial_shade, full_shade, hardiness_zone_range)
VALUES
